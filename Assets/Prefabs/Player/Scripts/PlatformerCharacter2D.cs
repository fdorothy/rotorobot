...
public class PlatformerCharacter2D : MonoBehaviour
{
    ...
    private bool m_Walking;             // Whether or not the player is moving along the ground
    ...
    public void SetPause(bool val)
    {
        if (val != m_Paused)
        {
            Debug.Log("setting pause to " + val);
        }
        m_Paused = val;
    }

    /**
     * Gets whether or not the character is paused.
     */
    public bool GetPause() { return m_Paused; }

    /**
     * Gets whether or not the character is walking on the ground.
     */
